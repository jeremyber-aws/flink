...
public class AmazonOpenSearchSink<InputT> extends AsyncSinkBase<InputT, String> {
    ...
    public AmazonOpenSearchSink(String indexName, String hostname, int port, String scheme) {
        super(
    ...
    public SinkWriter<InputT, Void, Collection<String>> createWriter(
            InitContext context, List<Collection<String>> states) throws IOException {
