...
public class AmazonKinesisDataStreamSink<InputT>
    ...
    /**
     * Basic service properties and limits. Supported requests per sec, max batch size, max items
     * per batch, etc.
     */
    ...
    public AmazonKinesisDataStreamSink(
            String streamName,
    ...
    private class AmazonKinesisDataStreamWriter
